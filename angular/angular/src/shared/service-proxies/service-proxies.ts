...
@Injectable()
export class PersonServiceServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    createPerson(body: CreatePersonInput | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/PersonService/CreatePerson";
        url_ = url_.replace(/[?&]$/, "");
    ...
    deletePerson(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/PersonService/DeletePerson?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
    ...
    getPeople(filter: string | undefined): Observable<ListResultDtoOfPersonListDto> {
        let url_ = this.baseUrl + "/api/services/app/PersonService/GetPeople?";
        if (filter === null)
     ...
     * @return Success
     */
    updatePerson(body: UpdatePersonInput | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/PersonService/UpdatePerson";
        url_ = url_.replace(/[?&]$/, "");
...
export class UpdatePersonInput implements IUpdatePersonInput {
    ...
    constructor(data?: IUpdatePersonInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UpdatePersonInput {
        data = typeof data === 'object' ? data : {};
        let result = new UpdatePersonInput();
        result.init(data);
        return result;
    }
